...
{
    //Utility function to get the available moves of the given King at any point of time
    ...
    //Utility function to get the special moves of the given King at any point of time
    public override SpecialMove GetSpecialMoves(ref ChessPiece[,] board, ref List<Vector2Int[]> moveList, ref List<Vector2Int> availableMoves)
    {
        SpecialMove r = SpecialMove.None;

        //if (!AnimHandler.instance.NotinCheck())
        //{
        //    return r;
        //}
